...
kanban org get 3
kanban team get 7
kanban board list  # Should show shared boards
```
...
kanban board get 15  # Check current state
...
kanban board list  # Check what boards exist

# Error: "Column not found"
kanban board get <board-id>  # Get correct column IDs
